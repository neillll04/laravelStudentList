...
<header class="mt-5 max-w-lg mx-auto">
   <a href="#">
      <h1 class="text-4xl font-bold text-white text-center animate__animated animate__flipInY animate__delay-1s"> Edit {{$student->first_name }} {{$student->last_name }}</h1>
   </a>
</header>
<main class="bg-white max-w-lg mx-auto p-8 my-10 rounded-lg shadow-2xl">
   ...
   <section class="mt-10">
      ...
      <form action="/student/{{$student->id}}" method="POST" class="flex flex-col">
         ...
         <button type="submit" class="bg-cyan-500 hover:bg-gradient-to-r from-cyan-600 to-blue-700 text-white font-bold py-2 rounded shadow-lg hover:shadow-xl transitionduration-200" type="submit">Update</button>
         
         </form>
         <form action="" method="POST">
            @method('delete')
            @csrf
            <button type="submit" class="w-full mt-2 bg-cyan-500  hover:bg-red-600 text-white font-bold py-2 rounded shadow-lg hover:shadow-xl transitionduration-200" type="submit">Delete</button>
         </form>
   </section>
</main>
